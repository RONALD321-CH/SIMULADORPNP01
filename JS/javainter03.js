...
let imagenesPorPregunta = [
    "img04/respuesta_0_1.png", // Imagen para la pregunta 0
    "img04/respuesta_1_1.png", // Imagen para la pregunta 1
    "img04/respuesta_2_1.png", // Imagen para la pregunta 2
    "img04/respuesta_3_1.png", // Imagen para la pregunta 3
    "img04/respuesta_4_1.png", // Imagen para la pregunta 4
    "img04/respuesta_5_1.png", // Imagen para la pregunta 5
    "img04/respuesta_6_1.png", // Imagen para la pregunta 6
    "img04/respuesta_7_1.png", // Imagen para la pregunta 7
    "img04/respuesta_8_1.png", // Imagen para la pregunta 8
    "img04/respuesta_9_1.png"  // Imagen para la pregunta 9
  
];

let correctas = [5, 5, 5, 3, 3, 5, 5, 5, 5, 5]; // Respuestas correctas para cada pregunta
