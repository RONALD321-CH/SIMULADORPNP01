...
let imagenesPorPregunta = [
    "img07/respuesta_0_1.png", // Imagen para la pregunta 0
    "img07/respuesta_1_1.png", // Imagen para la pregunta 1
    "img07/respuesta_2_1.png", // Imagen para la pregunta 2
    "img07/respuesta_3_1.png", // Imagen para la pregunta 3
    "img07/respuesta_4_1.png", // Imagen para la pregunta 4
    "img07/respuesta_5_1.png", // Imagen para la pregunta 5
    "img07/respuesta_6_1.png", // Imagen para la pregunta 6
    "img07/respuesta_7_1.png", // Imagen para la pregunta 7
    "img07/respuesta_8_1.png", // Imagen para la pregunta 8
    "img07/respuesta_9_1.png"  // Imagen para la pregunta 9
  
];

let correctas = [3, 1, 3, 5, 3, 5, 5, 5, 1, 2]; // Respuestas correctas para cada pregunta
