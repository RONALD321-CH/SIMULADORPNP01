...
let imagenesPorPregunta = [
    "img05/respuesta_0_1.png", // Imagen para la pregunta 0
    "img05/respuesta_1_1.png", // Imagen para la pregunta 1
    "img05/respuesta_2_1.png", // Imagen para la pregunta 2
    "img05/respuesta_3_1.png", // Imagen para la pregunta 3
    "img05/respuesta_4_1.png", // Imagen para la pregunta 4
    "img05/respuesta_5_1.png", // Imagen para la pregunta 5
    "img05/respuesta_6_1.png", // Imagen para la pregunta 6
    "img05/respuesta_7_1.png", // Imagen para la pregunta 7
    "img05/respuesta_8_1.png", // Imagen para la pregunta 8
    "img05/respuesta_9_1.png"  // Imagen para la pregunta 9
  
];

let correctas = [3, 4, 2, 1, 2, 1, 1, 1, 2, 4]; // Respuestas correctas para cada pregunta
