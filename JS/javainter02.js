...
let imagenesPorPregunta = [
    "img03/respuesta_0_1.png", // Imagen para la pregunta 0
    "img03/respuesta_1_1.png", // Imagen para la pregunta 1
    "img03/respuesta_2_1.png", // Imagen para la pregunta 2
    "img03/respuesta_3_1.png", // Imagen para la pregunta 3
    "img03/respuesta_4_1.png", // Imagen para la pregunta 4
    "img03/respuesta_5_1.png", // Imagen para la pregunta 5
    "img03/respuesta_6_1.png", // Imagen para la pregunta 6
    "img03/respuesta_7_1.png", // Imagen para la pregunta 7
    "img03/respuesta_8_1.png", // Imagen para la pregunta 8
    "img03/respuesta_9_1.png"  // Imagen para la pregunta 9
  
];

let correctas = [5, 3, 2, 2, 1, 2, 3, 4, 1, 2]; // Respuestas correctas para cada pregunta
