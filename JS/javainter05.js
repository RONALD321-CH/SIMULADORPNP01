...
let imagenesPorPregunta = [
    "img06/respuesta_0_1.png", // Imagen para la pregunta 0
    "img06/respuesta_1_1.png", // Imagen para la pregunta 1
    "img06/respuesta_2_1.png", // Imagen para la pregunta 2
    "img06/respuesta_3_1.png", // Imagen para la pregunta 3
    "img06/respuesta_4_1.png", // Imagen para la pregunta 4
    "img06/respuesta_5_1.png", // Imagen para la pregunta 5
    "img06/respuesta_6_1.png", // Imagen para la pregunta 6
    "img06/respuesta_7_1.png", // Imagen para la pregunta 7
    "img06/respuesta_8_1.png", // Imagen para la pregunta 8
    "img06/respuesta_9_1.png"  // Imagen para la pregunta 9
  
];

let correctas = [4, 3, 2, 4, 2, 5, 5, 5, 4, 3]; // Respuestas correctas para cada pregunta
